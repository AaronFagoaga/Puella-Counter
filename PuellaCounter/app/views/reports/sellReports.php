                ...
                <table id="genericTable" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        <?php foreach ($reports as $report) : ?>
                            <tr>
                                <td><?= htmlspecialchars($report['id_sell_recipt']) ?></td>
                                <td><?= htmlspecialchars($report['sell_type']) ?></td>
                                <td><?= htmlspecialchars($report['sell_number']) ?></td>
                                <td><?= htmlspecialchars($report['sell_date']) ?></td>
                                <td><?= number_format(htmlspecialchars($report['sell_amount']), 2) ?></td>
                                <td><?= htmlspecialchars($report['sell_client']) ?></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                    <tfoot>
